...
from app.models.ticket import Ticket, TicketType, TicketPriority
...
class AIAudit(Base):
    ...
    suggested_priority = Column(SQLEnum(TicketPriority, name="ticket_priority_enum", create_type=False), nullable=False)
    ...
    ticket = relationship("Ticket", back_populates="ai_audit")
...
class ChangeAudit(Base):
    ...
    ticket = relationship("Ticket", back_populates="change_audits")